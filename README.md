...
1. **Absolute Difference Check**  
   _Take two integers `m` and `n`. Use the ternary operator to print whether the absolute difference between them is greater than 10 or not._  
   Example:  
   Input → m = 25, n = 12  
...
5. **Check Middle Digit vs Sum of First & Last**  
   ...
   Example:  
   Input → 572 → Middle digit = 7 vs (5+2=7) → Equal or Not Greater  
